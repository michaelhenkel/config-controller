...
func (res *VirtualNetworkReconciler) ReversePath() []string {
	return []string{"VirtualMachine", "VirtualMachineInterface", "VirtualNetwork"}
}
...
func (r *VirtualNetworkReconciler) List(node string) error {
	List(node, "VirtualNetwork", r)
	return nil
}
