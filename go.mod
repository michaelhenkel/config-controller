module github.com/michaelhenkel/config-controller
...
require (
	...
	ssd-git.juniper.net/contrail/cn2/third_party/apiserver-builder-alpha v0.0.0-00010101000000-000000000000 // indirect
)
