...
import (
	...
	contrailScheme "ssd-git.juniper.net/contrail/cn2/contrail/pkg/client/clientset_generated/clientset/scheme"
...
func main() {
	...
	contrailClientSet, err := contrailClientset.NewForConfig(config)
	if err != nil {
		setupLog.Error(err, "unable to add contrail clientset")
		os.Exit(1)
	}

	ctrl.SetLogger(zap.New(zap.UseFlagOptions(&opts)))
	if err := contrailScheme.AddToScheme(scheme); err != nil {
		setupLog.Error(err, "unable to add contrail scheme")
		os.Exit(1)
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "7f2758f4.github.com",
	})
	if err != nil {
